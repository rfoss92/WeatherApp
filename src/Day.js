...
class Day extends Component {
  render() {
    ...
    return (
      <div className="col-xs-6 weather-info center-block">
        <p className="weather__key">{this.props.currentDayOfWeek}</p>
        <p className="weather__key">{this.props.currentDate}</p>
